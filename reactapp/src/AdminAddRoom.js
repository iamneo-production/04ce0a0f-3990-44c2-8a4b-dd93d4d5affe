        ...
        <div className="addRoomBox" id="addRoomBox">
            ...
            <table className="t" align="center"  width="30%" bgcolor="#F5F1F1" cellSpacing="20">
                <table width="40%" cellSpacing="1"> 
                 <tr> <input className="back"  type="button" value="< back" onClick={backBtn} /><br/></tr>   
                 ...
                 <br/><br/>
                    <center> <input onClick={addRoom} className="addRoomButton" id="addRoomButton"  type="button" value="Add Room"/></center> 
                </table>
             </table>
            </form>
        </div>
